...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
    <%
        ...
        While readerRequests.Read
            ...
            countNeedPickUps = CStr(readerRequests("countNeedPickUps"))
                        ...
                        <a href="../Request/RequestDashboard.aspx?SessionUserID=<% Response.Write(sessionUserID) %>&SessionRoleID=<% Response.Write(sessionRoleID) %>">
                            ...
                            <div class="info">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-xs-6 pull-left">
                                        <p class="goleft"><% Response.Write(countRequests)%> Requests</p>
                                    </div>
                                    <div class="col-sm-6 col-xs-6 pull-right">
                                        <p class="goright"><% Response.Write(countNeedPickUps)%> PickUps</p>
                                    </div>
                                </div>
                            </div>
                        </a>
