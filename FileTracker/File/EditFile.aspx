<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/User.Master"
    CodeBehind="EditFile.aspx.vb" Inherits="FileTracker.EditFile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        <h3 class="page-title"><i class="fa fa-file" aria-hidden="true"></i> Edit File</h3>
        <hr />
       	<div class="row st">
          	<div class="col-lg-12">
                <div class="form-panel">
                    ...
                    <div class="form-horizontal style-form">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">Last Four of SSN *</label>
                            <div class="col-sm-4">
...
<%--                                <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="purgeTypeDate" Format="MM/dd/yyyy"></ajaxToolkit:CalendarExtender>--%>
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-sm-2 col-sm-2 control-label">Destroyed *</label>
                            <div class="col-sm-4">
                               <asp:DropDownList ID="Destroyed" runat="server" class="form-control">
                                  <asp:ListItem Text="Yes" Value="1"></asp:ListItem>
                                  <asp:ListItem Text="No" Value="0"></asp:ListItem>
                               </asp:DropDownList>
                                <asp:RequiredFieldValidator ID="requiredDestroyed" runat="server" controltovalidate="Destroyed"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="form-group">
