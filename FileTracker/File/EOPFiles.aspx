<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/User.Master" CodeBehind="EOPFiles.aspx.vb" Inherits="FileTracker.EOPFiles" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
  ...
  <section id="main-content">
      <section class="wrapper site-min-height">
           <h3 class="page-title"><i class="fa fa-calendar" aria-hidden="true"></i> End Of Particpation Files</h3>
           <hr />
   	       <div class="row st">
          	    <div class="col-lg-12">
