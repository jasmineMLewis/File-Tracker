...
Public Class CancelRequestedFile
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        CancelFile(requestID)
        EmailCheckInConfirmation(sessionUserID, requestID)
        context.Response.Redirect(context.Request.UrlReferrer.ToString())
    End Sub

    Public Sub CancelFile(ByVal requestID As Integer)
        conn.Open()
        Dim query As New SqlCommand("UPDATE Request
                                     SET IsCancelled = '1', CancelledDate = '" & DateTime.Now & "' 
    ...
    Public Sub EmailCheckInConfirmation(ByVal sessionUserID As Integer, ByVal requestID As Integer)
        Try
            ...
            msg.Subject = "File Tracker :: (CANCEL) Request Number - " + requestID.ToString() + ", Checked Out by - " + sessionUserName
            msg.IsBodyHtml = True
