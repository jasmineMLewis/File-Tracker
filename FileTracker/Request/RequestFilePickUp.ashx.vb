...
Public Class RequestFilePickUp
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        RequestPickUp(sessionUserID, requestID)
        EmailCheckInConfirmation(sessionUserID, requestID)
        context.Response.Redirect(context.Request.UrlReferrer.ToString())
    End Sub

    Public Sub RequestPickUp(ByVal sessionUserID As Integer, ByVal requestID As Integer)
        Dim pickUpRequestDate As DateTime = DateTime.Now
        conn.Open()
        Dim query As New SqlCommand("UPDATE Requests SET IsPickUpRequested = '1', PickUpRequestDate = '" & pickUpRequestDate & "' WHERE pk_RequestID = '" & requestID & "'", conn)
    ...
    Public Sub EmailCheckInConfirmation(ByVal sessionUserID As Integer, ByVal requestID As Integer)
        Try
            ...
            msg.Subject = "File Tracker :: Request Number - " + requestID.ToString() + ", Pick Up Request by - " + sessionUserName
            msg.IsBodyHtml = True
