<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/User.Master" CodeBehind="CreateRequest.aspx.vb" Inherits="FileTracker.CreateRequest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        <h3 class="page-title"><i class="fa fa-cart-plus" aria-hidden="true"></i> Create Request</h3>
        <hr />
       	<div class="row st">
            <div class="col-lg-12">
                <div class="form-panel">
                    ...
                    <div class="form-horizontal style-form">
                        ...
                        <button id="button" type="button" class="btn btn-theme btn-lg btn-block" runat="server" onserverclick="btnCreateRequest">
                         <i class="fa fa-cart-plus" aria-hidden="true"></i> Create Request
                        </button>
